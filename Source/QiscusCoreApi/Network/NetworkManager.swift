...
class NetworkManager {
    ...
    init(core: QiscusCoreAPI) {
        self.clientRouter   = Router<APIClient>(core: core)
        self.roomRouter     = Router<APIRoom>(core: core)
        self.commentRouter  = Router<APIComment>(core: core)
        self.userRouter     = Router<APIUser>(core: core)
    }
